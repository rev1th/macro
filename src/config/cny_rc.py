...
def get_swaps_curve(val_date: dtm.date, fixing_type: str = 'FR007') -> list[DomesticSwap]:
...
def construct():
    val_date, spot_instrument, fxfwd_instruments = get_fx_curve()
    swaps_1 = get_swaps_curve(val_date, fixing_type='FR007')
    swaps_2 = get_swaps_curve(val_date, fixing_type='Shibor3M')
    curve_defs = [
        RateCurveModel(
            fxfwd_instruments,
